...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new xillio-engine.EntityResponse();
  });
  ...
  describe('EntityResponse', function() {
    it('should create an instance of EntityResponse', function() {
      // uncomment below and update the code to test EntityResponse
      //var instane = new xillio-engine.EntityResponse();
      //expect(instance).to.be.a(xillio-engine.EntityResponse);
    });
