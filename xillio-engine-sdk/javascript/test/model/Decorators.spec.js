...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new xillio-engine.Decorators();
  });
  ...
  describe('Decorators', function() {
    it('should create an instance of Decorators', function() {
      // uncomment below and update the code to test Decorators
      //var instane = new xillio-engine.Decorators();
      //expect(instance).to.be.a(xillio-engine.Decorators);
    });
