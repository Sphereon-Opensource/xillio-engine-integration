...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new xillio-engine.HashDecorator();
  });
  ...
  describe('HashDecorator', function() {
    it('should create an instance of HashDecorator', function() {
      // uncomment below and update the code to test HashDecorator
      //var instane = new xillio-engine.HashDecorator();
      //expect(instance).to.be.a(xillio-engine.HashDecorator);
    });
