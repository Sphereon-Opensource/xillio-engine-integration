...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new xillio-engine.AllApi();
  });
  ...
  describe('AllApi', function() {
    ...
    describe('deleteEntity', function() {
      it('should call deleteEntity successfully', function(done) {
        ...
        //instance.deleteEntity(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getContent', function() {
      it('should call getContent successfully', function(done) {
        ...
        //instance.getContent(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEntity', function() {
      it('should call getEntity successfully', function(done) {
        ...
        //instance.getEntity(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateContent', function() {
      it('should call updateContent successfully', function(done) {
        ...
        //instance.updateContent(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateEntity', function() {
      it('should call updateEntity successfully', function(done) {
        ...
        //instance.updateEntity(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
