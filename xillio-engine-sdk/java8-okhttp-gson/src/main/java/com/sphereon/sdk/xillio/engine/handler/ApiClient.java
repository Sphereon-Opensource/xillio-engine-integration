...
package com.sphereon.sdk.xillio.engine.handler;

import com.sphereon.sdk.xillio.engine.handler.auth.ApiKeyAuth;
import com.sphereon.sdk.xillio.engine.handler.auth.Authentication;
import com.sphereon.sdk.xillio.engine.handler.auth.HttpBasicAuth;
import com.sphereon.sdk.xillio.engine.handler.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.xill.io/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.xill.io/v2
    ...
    public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams) {
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                // FIXME: 2-11-2017 Hack, since Xillio API does not accept octet-stream as mediatype for the json entity
                MediaType contentType = null;
                if ("entity".equalsIgnoreCase(param.getKey())) {
                    contentType = MediaType.parse("application/json");
                }
                // End hack
                mpBuilder.addPart(partHeaders, RequestBody.create(contentType, parameterToString(param.getValue())));
            }
        }
